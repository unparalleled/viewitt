...
public class MediaUtils {
    ...
    /**
     * A copy of the Android internals insertImage method, this method populates the meta data with DATE_ADDED and DATE_TAKEN. This fixes a common problem where
     * media that is inserted manually gets saved at the end of the gallery (because date is not populated).
     *
